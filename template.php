 ...
 */
function mukurtu_subtheme_preprocess_html(&$variables) {
    $color_scheme = theme_get_setting('mukurtu_subtheme_theme_color_scheme');
 ...
 */
function _mukurtu_subtheme_include_slick_carousel() {
    ...
    drupal_add_js($js);
    $js = join('/', array(drupal_get_path('theme', 'mukurtu_subtheme'), 'js', 'mukurtu-slick-carousel.js'));
    drupal_add_js($js);
}

function mukurtu_subtheme_preprocess_page(&$vars, $hook = null){
    if (isset($vars['node'])) {
        switch ($vars['node']->type) {
        case 'collection':
            $js = join('/', array(drupal_get_path('theme', 'mukurtu_subtheme'), 'js', 'collection-grid.js'));
            drupal_add_js($js);
            break;
        case 'digital_heritage':
        case 'person':
            _mukurtu_subtheme_include_slick_carousel();
    ...
    if(isset($vars['page']['content']['system_main']['term_heading']['term']['field_mukurtu_subtheme_records'])) {
        _mukurtu_subtheme_include_slick_carousel();
    }
}

function mukurtu_subtheme_preprocess_panels_pane(&$variables) {
...
function mukurtu_subtheme_preprocess_field(&$variables, $hook) {
...
function mukurtu_subtheme_block_view_alter(&$data, $block) {
    ...
    $frontpage_hero_setting = theme_get_setting('mukurtu_subtheme_theme_frontpage_layout', 'mukurtu_subtheme');
...
*/
function mukurtu_subtheme_node_view_alter(&$build) {
