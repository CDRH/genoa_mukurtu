 ...
 */
function _genoa_mukurtu_include_slick_carousel() {
    ...
    drupal_add_js($js);
    $js = join('/', array(drupal_get_path('theme', 'genoa_mukurtu'), 'js', 'genoa_mukurtu-slick-carousel.js'));
    drupal_add_js($js);
}
...
function genoa_mukurtu_preprocess_page(&$vars, $hook = null){
    ...
    // Taxonomy terms w/genoa_mukurtu Records
