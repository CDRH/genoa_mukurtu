 ...
 */
?>
<?php if (isset($mukurtu_subtheme_tabbed_local_tasks[$nid]) && !empty($mukurtu_subtheme_tabbed_local_tasks[$nid])): ?>
<div class="btn-group">
...
<?php print render($mukurtu_subtheme_tabbed_local_tasks[$nid]);?>
</ul>
</div>
<?php endif; ?>
