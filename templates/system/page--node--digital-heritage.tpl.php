...
<div id="mukurtu-multipage-carousel" class="slick-carousel slick-carousel-multipage">
  <?php
    ...
    if(!empty($first_page->field_media_asset[LANGUAGE_NONE])) {
        ...
        print "<a href='$url'>";
        print scald_render($sid, 'mukurtu_subtheme_multi_page_carousel');
        print "</a></div>";
    ...
    drupal_add_js(array('mukurtu_subtheme' => array('dh_multipage_initial_slide' => $initial_slide)), 'setting');
    $initial_slide++;
    $dh_page++;
  ?>
</div>
